...
Route::get('/ease', array('uses' => 'HomeController@easemob'));

///************************API*************************///
Route::get('/api', array('uses' => 'ApiController@ShowApi'));
Route::get('/api/hello', array('uses' => 'ApiController@HelloG'));
Route::post('/api/hello', array('uses' => 'ApiController@HelloP'));

/*******************easemob*******************************/
Route::get('/layout', function(){return View::make('easelayout');});
Route::get('/test', function(){return View::make('testease');});
